                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>">
						...
						<div class="form-group<?php echo e($errors->has('uname') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="uname" type="text" class="form-control" name="uname" value="<?php echo e(old('uname')); ?>" required autofocus>
						...
						<div class="form-group<?php echo e($errors->has('status') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="status" type="text" class="form-control" name="status" value="<?php echo e(old('status')); ?>" required autofocus>
						...
						<div class="form-group<?php echo e($errors->has('cno') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="cno" type="text" class="form-control" name="cno" value="<?php echo e(old('cno')); ?>" required autofocus>
